...
const FloatFooter = () => {
  return (
    <div className="sm:max-w-lg w-full mx-auto fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-md z-50 flex justify-around items-center py-5">
